...
MAX_TEG_LINE_LEN = 300        # максимальная длина тегов
MAX_BLANK_DES_LEN = 2400      # максимальная длина описания в бланке
...
TGM = 20                     # время в секундах до удаления важных сообщений системы
TRM = 10                     # время в секундах до удаления до удаления вводимого текста
TCM = 5                      # время в секундах до удаления команды

ON_BOT_BLOCKED_BAN = False   # банить пользователя, если он заблокировал бота
ON_BOT_BLOCKED_DEL = True    # удалять пользователя, если он заблокировал бота
...
help_mes = '<b>информация:</b> мы занимаемся разработкой рп-бота с функциями на подобие RoleMe\n' \
           ...
           '<a href="https://youtu.be/XKzdsphHt6A">&gt; видео-гайд</a>\n' \
